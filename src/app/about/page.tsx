        ...
        <section className="mb-12">
          <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
            ...
            <div className="space-y-2 text-sm text-gray-600">
              ...
              <p><strong className="text-gray-700">Report:</strong> $5 one-time</p>
              <p><strong className="text-gray-700">Included:</strong> 5 AI-matched ideas, competitor analysis, MVP scope, ship plan, PDF export</p>
            </div>
          </div>
        </section>
